          ...
          <Advertising className="flexSpaceCenter">
            ...
            <AddRight>
              ...
              <div className="row" style={{ marginTop: 20 }}>
                <div className="col-md-6 col-xs-6" style={{ padding: '0 5px' }}>
                  <div className="pricing-box">
                    <img   onClick={() => setShowModal(true)} src="https://res.cloudinary.com/dqmo9ctjb/image/upload/v1775736569/Asset_5_4x_npfvwp.png" style={{ width: '100%', borderRadius: '10px' }} alt="" />
                  </div>
                </div>
                <div className="col-md-6 col-xs-6" style={{ padding: '0 5px' }}>
                  <div className="pricing-box">
                    <img   onClick={() => setShowModal(true)} src="https://res.cloudinary.com/dqmo9ctjb/image/upload/v1775736568/Asset_2_4x_jr2ppz.png" style={{ width: '100%', borderRadius: '10px' }} alt="" />
                  </div>
                </div>
              ...
              <div className="row" style={{ marginTop: 20 }} >
                <div className="col-md-6 col-xs-6" style={{ padding: '0 5px' }}>
                  <div className="pricing-box">
                    <img   onClick={() => setShowModal(true)} src="https://res.cloudinary.com/dqmo9ctjb/image/upload/v1775736568/Asset_3_4x_bbamqt.png" style={{ width: '100%', borderRadius: '10px' }} alt="" />
                  </div>

                </div>
                <div className="col-md-6 col-xs-6" style={{ padding: '0 5px' }}>
                  <div className="pricing-box">
                    <img   onClick={() => setShowModal(true)} src="https://res.cloudinary.com/dqmo9ctjb/image/upload/v1775736568/Asset_4_4x_ummjn9.png" style={{ width: '100%', borderRadius: '10px' }} alt="" />
                  </div>
